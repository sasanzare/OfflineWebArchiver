...
Fitness gates independently validate build/type safety, formatting/lint, package allowlists/cycles/public entries/Core/Queue purity/app non-persistence, all 32 commands in contract 1.3.0, Project format, migrations, Queue policy, Desktop security, documentation/ADRs, security, and OKF. Lease/Heartbeat/Checkpoint/stale recovery, browser/network/auth/proxy/crawler fixtures are not claimed.
