...
| S13-004: Full Worker Pool concurrency stress is not executable yet | Medium | Queue / Reliability | Phase 14+ scheduler work | NOT_APPLICABLE to the Phase 13 runtime because the scheduler was intentionally outside that phase. Product Phase 16 now supplies focused Worker Pool and SQLite scheduler-state evidence; long-running target soak remains later work. | AC-P13-018, AC-P13-019 |
