...
| `okf_version` | `RESERVED_FILE_ONLY` | String constant `"0.2"` | Required by repository only in `okf/bundle/index.md`; forbidden elsewhere | Root-index author | Reserved-file `ERROR` | Official root-index-only optional declaration | `okf_version: "0.2"` | Target architecture |
