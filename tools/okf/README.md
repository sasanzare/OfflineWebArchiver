...
CI runs the same commands through the `OKF Validation` workflow. Official, policy, extension, and repository formatting gates block; knowledge-quality warnings remain non-blocking. The JSON report is uploaded as `okf-conformance-report`.
